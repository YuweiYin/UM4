...
def load_align_dict(replace_unk):
    if replace_unk is None:
        ...
        # No alignment dictionary provided,
        # but we still want to perform unknown word replacement by copying the original source word.
        align_dict = {}
    return align_dict
...
def resolve_max_positions(*args):
    ...
    def nullsafe_min(_l):
        ...
        for _item in _l:
            if minim is None:
                minim = _item
            elif _item is not None and _item < minim:
                minim = _item
        return minim
