...
class TransformerLanguageModelConfig(FairseqDataclass):
    ...
    no_scale_embedding: bool = field(
        default=False, metadata={"help": "if True, don't scale embeddings"}
    )
    ...
    def hub_models(cls):
        ...
        return {
            "transformer_lm.gbw.adaptive_huge":
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/adaptive_lm_gbw_huge.tar.bz2",
            "transformer_lm.wiki103.adaptive":
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/adaptive_lm_wiki103.v2.tar.bz2",
