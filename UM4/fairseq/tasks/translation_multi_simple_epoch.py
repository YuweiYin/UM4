...
class TranslationMultiSimpleEpochTask(LegacyFairseqTask):
    ...
    def __init__(self, args, langs, dicts, training):
        ...
        # eval_lang_pairs for multilingual translation is usually all the
        ...
        # models.build_model(). This allows multitasking type of subclass can
            ...
            if self.has_sharded_data(split):
                if self.args.virtual_epoch_size is not None:
                    if dataset.load_next_shard:
                        ...
                        # also this avoids always loading from beginning of the data
                        return
                else:
                    shard_epoch = epoch
        else:
